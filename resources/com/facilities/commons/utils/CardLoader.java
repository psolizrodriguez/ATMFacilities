...
import com.facilities.model.customer.CustomerImpl;
...
public class CardLoader {
	public static List<Card> getPNCCards() {
		...
		Customer customer = new CustomerImpl("CUST001", "SOLIZ", "PERCY", billingAddress, billingAddress);
	...
	public static List<Card> getBOACards() {
		...
		Customer customer = new CustomerImpl("CUST002", "SINDHU", "PINKY", billingAddress, billingAddress);
